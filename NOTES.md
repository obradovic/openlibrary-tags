NOTES:
    How is "key" different from "work id" ?  It is the same
    How often is the same tag string in multiple classifications (general, people, places, times)?
    What languages are tags written in?
    What are the most popular tags?
    Do tag frequencies obey a power law?
    How many works have zero tags?
    How many works have only one tag?
    Is there a good way to increase the number of tags for books that have zero tags?
    ...
    First pass:
        ...
        Fix tags that have leading or trailing spaces in them
